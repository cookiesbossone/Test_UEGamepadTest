...
{
	UE_LOG(LogRawInputWindows, Warning, TEXT("FRawInputWindows::QueryConnectedDevices()"));
	...
	UE_LOG(LogRawInputWindows, Warning, TEXT("DeviceList Num = %d"), DeviceList.Num());
	
	UE_LOG(LogRawInputWindows, Warning, TEXT("-------- Device loop start --------"));

	int deviceIndex = 0;
	for (const RAWINPUTDEVICELIST& Device : DeviceList)
	{
		UE_LOG(LogRawInputWindows, Warning, TEXT("--- device index = %d, device dwType = %d"), deviceIndex, Device.dwType);
		...
		UE_LOG(LogRawInputWindows, Warning, TEXT("Orginal device name =  %s"), *DeviceName);
		...
		UE_LOG(LogRawInputWindows, Warning, TEXT("After device name = %s"), *DeviceName);
		...
		deviceIndex++;
		UE_LOG(LogRawInputWindows, Warning, TEXT("--- Device loop round end"));
	}

	UE_LOG(LogRawInputWindows, Warning, TEXT("-------- Device loop end --------"));
...
{
	UE_LOG(LogRawInputWindows, Log, TEXT("ShowDeviceInfo : %s"), *DeviceInfo.DeviceName);
